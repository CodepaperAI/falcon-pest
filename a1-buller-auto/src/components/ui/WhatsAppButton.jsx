 ...
 * -----------------------------------------------------------------------------
 * Floating WhatsApp button. Opens a chat WITH your number and a pre-filled
 * message.
 *
 * IMPORTANT — number format:
 *   Digits only, INCLUDING the country code, and NO "+", spaces, dashes, or
 *   parentheses. (604) 423-4524  ->  16044234524   (1 = US/Canada code).
 *   If the country code is missing, WhatsApp opens with just the text and no
 *   contact — which is the bug you saw.
 *
 * The number must also be an ACTIVE WhatsApp account, or WhatsApp will say
 * "phone number is not on WhatsApp".
 */

 const PHONE = "16044455057"; // (604) 423-4524, digits only + country code
