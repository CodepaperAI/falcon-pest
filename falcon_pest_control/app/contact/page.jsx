...
export default function ContactPage() {
  return (
    <main className="bg-black text-white">
      ...
      <PageBanner title="Contact Falcon" description="Reach out for a consultation, emergency support, or a customized protection plan." image="/hero1.png" eyebrow="Contact" />
      <Section>
            ...
            <div className="mt-8 grid gap-4">
              <Card className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#BDBDBD]">+1 (647) 123-4567</p>
                </div>
              </Card>
              <Card className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#BDBDBD]">hello@falconpestcontrol.com</p>
                </div>
              </Card>
              <Card className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#BDBDBD]">Toronto, Ontario</p>
                </div>
              </Card>
            </div>
          </FadeIn>
